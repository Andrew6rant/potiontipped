...
public class HandleTippedMiningToolItem extends MiningToolItem implements TippedTool{
    private final MiningToolItem parent;

    public HandleTippedMiningToolItem(MiningToolItem parent) {
        super(parent.getAttackDamage() - parent.getMaterial().getAttackDamage(),
                ...
                new Item.Settings().maxDamage(parent.getMaxDamage()));
